...
\begin{DoxyCompactList}\small\item\em Determines if any component is subscribed to a given topic and dispatches the message to it. \end{DoxyCompactList}\item 
...
Determines if any component is subscribed to a given topic and dispatches the message to it. 


\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{in}}  & {\em device} & The device instance. \\
\hline
\mbox{\texttt{in}}  & {\em topic} & Topic string. \\
\hline
\mbox{\texttt{in}}  & {\em topic\+\_\+len} & Length of the topic. \\
\hline
\mbox{\texttt{in}}  & {\em data} & Payload data. \\
\hline
\mbox{\texttt{in}}  & {\em data\+\_\+len} & Length of the payload. \\
\hline
\end{DoxyParams}
